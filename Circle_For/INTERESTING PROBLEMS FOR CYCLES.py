...
for i in range(1, 1000):
    for j in range(1, 1000):
        if i // 100 + i % 100 // 10 + i % 10 == j // 100 + j % 100 // 10 + j % 10:
            count += 1
print(f'Количество счастливых билетов в рулоне {count}')
...
for i in range(1, 50001):
    while i != 0:
        ...
        if n == 2:
            count += 1
            break
print(f'ошибочных табличек: {count}')
print()
...
for i in range(0, 24):
    for j in range(0, 60):
        if (i % 10 == j // 10) and (i //10 == j % 10):
            count += 1
print(f'Количество симметрий {count}')
...
for N in range(1, 100000):
    while N != 0:
        ...
        if n == 3:
            p = 3
        if (p == 3 and n == 1) or n == 4:
            count += 1
            break
print(f'нужно исключить номеров: {count}')